...
var Heteronyms = React.createClass({displayName: "Heteronyms",
	render: function() {
		var heteronyms = this.props.items.map(function(item) {
			return (
				React.createElement("div", null, 
					React.createElement("div", null, 
						item.bopomofo
					...
					React.createElement(Definition, {items: item.definitions})
				)
			)
		});
		...
		if(this.props.items.radical != undefined && this.props.items.title.length == 1) {
			...
			return (
				React.createElement("div", null, 
					...
					React.createElement(Heteronyms, {items: this.props.items.heteronyms})
			...
			return (
				React.createElement("div", null, 
					...
					React.createElement("div", null, 
						this.props.items.heteronyms[0].definitions
					)
				)
			)
		} else {
